...
class TestServiceConesearch(TestCase):
    ...
    def test_case1(self,cone_search_mock):
        ...
        result = service_get_conesearch(catalog = "FIRST", request = {"ra": 1, "dec" : 0, "radius": 200}, path = "/data")
    ...
    def test_case2(self,cone_search_mock2):
        with pytest.raises(Exception):
            ...
            result = service_get_conesearch(catalog = "FIRST", request = {"ra": 0, "dec" : 0, "radius": 0}, path = "/data")
